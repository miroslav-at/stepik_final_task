...
class BasePage():
    ...
    # Решает тест для получения кода
    ...
    # Проверяет, что указанный элемент не появляется на странице в течение заданного времени
    ...
    # Проверяет, что указанный элемент исчезает по истечении заданного времени
    ...
    # Проверяет наличие ссылки логина
